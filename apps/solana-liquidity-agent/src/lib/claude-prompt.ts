...
### Historical Trend:
- **Historical Analysis Available:** Yes (${poolHistory.dataPoints.length} data points)
...
**CRITICAL: DO NOT MENTION RISK SCORE IN YOUR REPORT**
- Do NOT include "Risk Score" anywhere in your report
- Do NOT calculate or mention any risk score
- Focus on providing detailed analysis and insights
- The security score is calculated automatically based on holder behavior metrics (re-entry ratio, diamond hands ratio, early buyers still holding ratio)

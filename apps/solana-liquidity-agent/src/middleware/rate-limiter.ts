...
const MAX_CONCURRENT_JOBS = parseInt(process.env.MAX_CONCURRENT_JOBS || '4', 10); // Max 4 concurrent jobs
const QUEUE_MAX_SIZE = parseInt(process.env.QUEUE_MAX_SIZE || '4', 10); // Max 4 total (4 active, no waiting queue)
